/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a0b2be9c61056fdae282fac148678d84)
...
declare namespace Cloudflare {
	interface Env {
		...
		NEXT_PUBLIC_STYLEBERTVITS2_MODEL_ID: string;
		NEXT_PUBLIC_STYLEBERTVITS2_STYLE: string;
		NEXT_PUBLIC_STYLEBERTVITS2_SDP_RATIO: string;
		NEXT_PUBLIC_STYLEBERTVITS2_LENGTH: string;
